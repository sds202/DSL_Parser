...
void ecobotParserInitialize() {
  ...
  static const int32_t serializedATNSegment[] = {
  	4,1,24,124,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
  	...
  	0,2,1,0,8,11,1,0,20,22,120,0,31,1,0,0,0,2,36,1,0,0,0,4,45,1,0,0,0,6,53,
...
tree::TerminalNode* EcoBotParser::ValueContext::NUM() {
  return getToken(EcoBotParser::NUM, 0);
}
